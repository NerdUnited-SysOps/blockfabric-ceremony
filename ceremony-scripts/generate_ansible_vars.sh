...
check_file "Bridge owner address" "${BRIDGE_OWNER_ADDRESS_FILE}/keystore"
...
all_quorum_vars() {
	...
	sed -i '/goquorum_genesis_sc_bridge_storage/d' ${ANSIBLE_DIR}/group_vars/all_quorum.yml
	echo "goquorum_genesis_sc_bridge_storage: ${sc_bridge_storage}" >> ${ANSIBLE_DIR}/group_vars/all_quorum.yml

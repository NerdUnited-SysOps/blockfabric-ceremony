...
[ -z "${SAFE_OWNER_1_ADDRESS_FILE}" ] && SAFE_OWNER_1_ADDRESS_FILE="$VOLUMES_DIR/volume1/safeOwner1"
[ -z "${SAFE_OWNER_2_ADDRESS_FILE}" ] && SAFE_OWNER_2_ADDRESS_FILE="$VOLUMES_DIR/volume2/safeOwner2"
[ -z "${SAFE_OWNER_3_ADDRESS_FILE}" ] && SAFE_OWNER_3_ADDRESS_FILE="$VOLUMES_DIR/volume3/safeOwner3"

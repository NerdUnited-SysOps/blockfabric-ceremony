...
persist_bridge_keys() {	
	...
	upsert_secret ${BRAND_AWS_APPROVER_PRIVATE_KEY} $BRIDGE_CONTRACT_ADDRESS ${AWS_PRIMARY_PROFILE}
	upsert_secret ${BLOCK_FABRIC_AWS_APPROVER_PRIVATE_KEY} $BRIDGE_CONTRACT_ADDRESS ${AWS_SECONDARY_PROFILE}
